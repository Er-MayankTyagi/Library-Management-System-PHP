...
elseif($msg=="fail"){
    ...
    ?>
  <p class=he> LIBRARY MANAGMENT SYSTEM</p>
        <!-- <div class="container" 
         <div class="innerdiv">   -->
            
            
            <!-- <div class="row"><img class="imglogo" src="images/new.png" width="700px" height="200px" style="padding-left: 50px;"/></div> -->
            <div class="photo">
            <img src="images/download.png" class="img-fluid" style="margin-left: 50px;" height="80px" alt="...">
        <img src="images/lib.png" class="img-fluid"  style="margin-left: 30px;"  alt="...">
        <img src="images/new.png" class="img-fluid" style="margin-left: 15px;" alt="...">
        <img src="images/POTO.png" class="img-fluid" style="margin-left: 15px;" alt="...">
        <img src="images/first.png" class="img-fluid" style="margin-left: 15px;" alt="...">
            </div>
...
?>
            ...
            <p style="color:"><u>Book Name:</u> &nbsp&nbsp<?php echo $bookname ?></p>
